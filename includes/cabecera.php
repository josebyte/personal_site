...
<header>
       <nav class="navbar navbar-default navbar-fixed-top <?php if($_COOKIE['eucookie']!=1){ ?> nofijo <?php } ?>" role="navigation" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="<?php if ($seccion=="curriculum"){ echo active; } ?>">
                  <a href="./"><span class="glyphicon glyphicon-list-alt"></span> Curriculum</a>
                </li>
                <li class="<?php if ($seccion=="portafolio"){ echo active; } ?>">
                ...
                <li class="<?php if ($seccion=="cartas"){ echo active; } ?>">
                  <a href="cartas.php">
